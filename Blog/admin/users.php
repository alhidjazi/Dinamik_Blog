                ...
                <?php
                        if(isset($_POST["add_user"])){
                            ...
                            if(!$create_user_query){
                                die("Bağlantı queryde hatalı bir cümle vardır !!: " .mysqli_error($conn));
                            }
                            else{
                    ...
                    ?>
                     <?php 
                        if(isset($_POST["edit_user"])){
                            ...
                            $sql_query2 = "UPDATE users SET user_name = '$user_name', user_email = '$user_email', user_password = '$user_password', 
